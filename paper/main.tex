...
\begin{abstract}
  We prove that every finite point set of size at~least~10\textsuperscript{11055931} has four collinear points or six points that pairwise see each other.
...
% lax begin Lax56.VertexRemovalStability
...
% lax end Lax56.VertexRemovalStability
\end{lemma}
